...
def process_file(input_file):
    ...
    for p in list(range(1, pages)):
        ...
        out_dir = os.path.join(book_dir, str(p))
...
def main():
    ...
    parser.add_argument('--use-hocr', dest="use_hocr", action='store_true', default=False,
                        help='Generate OCR by stripping HTML characters from HOCR, otherwise run tesseract a second time. Defaults to use tesseract.')
    parser.add_argument('--mods-dir', dest="mods_dir", default=None,
                        help="Directory of files with a matching name but with the extension '.mods' to be added to the books.")
    ...
    parser.add_argument('--skip-derivatives', dest="skip_derivatives", action='store_true', default=False,
                        help="Only split the source file into the separate pages and directories, don't generate derivatives.")
