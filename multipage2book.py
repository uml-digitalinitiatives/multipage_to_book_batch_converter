...
def main():
    ...
    parser.add_argument('--use-hocr', dest="use_hocr", action='store_true', default=False,
                        help='Generate OCR by stripping HTML characters from HOCR, otherwise run tesseract. Defaults to use tesseract.')
    ...
    parser.add_argument('--skip-derivatives', dest="skip_derivatives", action='store_true', default=False,
                        help="Only split the PDF into the separate pages and directories, don't generate derivatives.")
